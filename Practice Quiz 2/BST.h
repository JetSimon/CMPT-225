...
private:
	...
	int minR(BSTNode<ElementType>* current);

	int evenCountR(BSTNode<ElementType>* current);

	int oddCountR(BSTNode<ElementType>* current);
         
	int duplicateCountR(BSTNode<ElementType>* current, const ElementType targetElement);
		 
	int heightR(BSTNode<ElementType>* current, int currentHeight);

	int sumR(BSTNode<ElementType>* current);

	void printInReverseOrderR(BSTNode<ElementType>* current);
...
*/
	...
	int duplicateCount(const ElementType targetElement);
